...
const canOpenReview = Boolean(quiz?.attempt_id);
  ...
  return (
    <div className="flex h-full flex-col rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:p-6">
      {/* Header */}
...
function Field({ label, value, disabled = false, icon = null }) {
  return (
    <div className="grid grid-cols-1 items-start gap-1.5 sm:grid-cols-[110px_1fr] sm:items-center sm:gap-3">
