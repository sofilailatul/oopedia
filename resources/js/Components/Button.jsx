export default function Button({
  ...
  const base =
    "inline-flex items-center justify-center gap-3 rounded-xl font-semibold transition focus:outline-none focus:ring-4 disabled:opacity-50 disabled:cursor-not-allowed";
  ...
  const colors = {
    ...
    yellow: {
      ...
      outline:
        "border border-yellow-400 text-yellow-500 hover:bg-yellow-50 focus:ring-yellow-100",
      ghost: "text-yellow-500 hover:bg-yellow-50 focus:ring-yellow-100",
    },
    blue: {
  ...
  return (
    <button
      disabled={disabled}
      className={`${base} ${sizes[size]} ${colors[color][variant]} ${className}`}
      {...props}
    >
