...
export default function ManageQuizzesCreate({
  classes = [],
  materials = [],
  authUser,
}) {
  ...
  const handleSubmit = (e) => {
    ...
    setSaving(true);
    setError("");
    const routeName = isSuperadmin
      ? "superadmin.quizzes.store"
      : "quizzes.store";
                  ...
                  {classes.map((cls) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span
                          className={`h-2 w-2 rounded-full flex-shrink-0 ml-2 ${selected ? "bg-blue-500" : "bg-slate-300"}`}
                        />
                      </button>
                    );
                  })}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("start_at", e.target.value)
                    }
                    className="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm outline-none focus:border-blue-300 focus:ring-2 focus:ring-blue-50 transition-all bg-slate-50/50"
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("end_at", e.target.value)
                    }
                    className="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm outline-none focus:border-blue-300 focus:ring-2 focus:ring-blue-50 transition-all bg-slate-50/50"
                  />
                </div>
          ...
          <Card className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
            <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
              <div>
                ...
                <p className="mt-0.5 text-[11px] text-slate-500 pl-3">
                  Materi yang akan diujikan dalam kuis ini.
                </p>
              </div>
                  ...
                  {materials.map((m) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span
                          className={`text-sm font-medium truncate ${isSelected ? "text-emerald-900" : "text-slate-700"}`}
                        >
                          {m.material_name}
                        </span>
                      </div>
